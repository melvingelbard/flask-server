...
class ResNetUNet(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        # Start with a pretrained resnet34
...
class ResNetUNet_Fluorescent(nn.Module):
    def __init__(self, n_class):
        super().__init__()
        self.n_class = n_class
        ...
        self.first_block = [torch.nn.Conv2d(1, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False),
        ...
        #self.layer0 = nn.Sequential(*self.base_layers[:3]) # size=(N, 64, x.H/2, x.W/2)
        self.layer0 = nn.Sequential(*self.first_block) # size=(N, 64, x.H/2, x.W/2)
        self.layer0_1x1 = self.convrelu(64, 64, 1, 0)
        self.layer1 = nn.Sequential(*self.base_layers[3:5]) # size=(N, 64, x.H/4, x.W/4)
        self.layer1_1x1 = self.convrelu(64, 64, 1, 0)
        self.layer2 = self.base_layers[5]  # size=(N, 128, x.H/8, x.W/8)
        ...
        self.conv_original_size0 = self.convrelu(1, 64, 3, 1)
        self.conv_original_size1 = self.convrelu(64, 64, 3, 1)
        self.conv_original_size2 = self.convrelu(64 + 128, 64, 3, 1)
